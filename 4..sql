...
CD_NM,
REGION_AREA,
C0 || DECODE(C0, GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '▲') || DECODE(C0, LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '▼') C0, -- 같이 넣었을 경우에는 DECODE에 그러면 둘다 최소 최대값 나올수가 있다.그럼 아래일지 위에 일지 모름
