  SELECT AREA_CD
      ...
      ,REGION_AREA
      ,C0||
      ' '||DECODE(C0,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C0,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C0,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R0,1,2),'01',SUBSTR(R0,3,2),SUBSTR(R0,5)),'0') C0 -- LTRIMÀ¸·Î 0 ¾ø¾Ú
       ,C1||
       ' '||DECODE(C1,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C1,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C1,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R1,1,2),'01',SUBSTR(R1,3,2),SUBSTR(R1,5)),'0') C1
       ,C2||
       ' '||DECODE(C2,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C2,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C2,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R2,1,2),'01',SUBSTR(R2,3,2),SUBSTR(R2,5)),'0') C2
       ,C3||
       ' '||DECODE(C3,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C3,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C3,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R3,1,2),'01',SUBSTR(R3,3,2),SUBSTR(R3,5)),'0') C3
       ,C4||
       ' '||DECODE(C4,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C4,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C4,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R4,1,2),'01',SUBSTR(R4,3,2),SUBSTR(R4,5)),'0') C4
       ,C5||
       ' '||DECODE(C5,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C5,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C5,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R5,1,2),'01',SUBSTR(R5,3,2),SUBSTR(R5,5)),'0') C5
       ,C6||
       ' '||DECODE(C6,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C6,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C6,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R6,1,2),'01',SUBSTR(R6,3,2),SUBSTR(R6,5)),'0') C6
       ,C7||
       ' '||DECODE(C7,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C7,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C7,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R7,1,2),'01',SUBSTR(R7,3,2),SUBSTR(R7,5)),'0') C7
       ,C8||
       ' '||DECODE(C8,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C8,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C8,0,:v_last)
      ||LTRIM(DECODE(GR,'00',SUBSTR(R8,1,2),'01',SUBSTR(R8,3,2),SUBSTR(R8,5)),'0') C8
       ,C9||
       ' '||DECODE(C9,GREATEST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9), '¡ã')
      ||DECODE(C9,LEAST(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9),'¡å')||' *'||DECODE(C9,0,:v_last)
